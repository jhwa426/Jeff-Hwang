...
export const projects = [
    {
        ...
        description: "Healthcare Platform - CarePulse",
        descriptionDetails: [
        ...
        github: "https://github.com/jhwa426/Patient-Management-System",
        website: "https://patient-management-system-carepulse.vercel.app/",
        members: [
            {
                name: "Jeff Hwang",
                img: "./img/jeff.png",
...

    {
        ...
        descriptionDetails: [
            ...
            "Implemented a persistent storage application for CRUD on the website (Create the court, Read the current booking, Update the court and Delete the court) through a RESTful API",
...

    {
        ...
        descriptionDetails: [
            "Implemented the React Icons library in various React projects",
            "Utilised React useState hooks for state management",
            "Developed modern website designs using CSS3.",
            "Enhanced development speed with intuitive React UI tools",
            "Leveraged MUI libraries to access a comprehensive suite of free UI tools for faster feature deployment",
            "Added multiple contact options on the website, including WhatsApp and Facebook Messenger",
...

    {
        ...
        descriptionDetails: [
            "Implemented SVG animations using GSAP and React",
            "Integrated font icons in React",
            "Developed and integrated a contact form in React using EmailJS",
        ],
...

    {
        ...
        descriptionDetails: [
            "Implemented SVG animation using GSAP and React",
            "Animated letters on hover using Animate.css and React",
            "Added page loading animation using React-Loaders",
            "Integrated Pacman animation in React",
            "Created custom 3D CSS animations",
            "Implemented font icons in React",
            "Developed and integrated a contact form in React using EmailJS",
            "Added maps to the website in React using Leaflet.js"
        ],
